        ...
        mPlayBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentTimeMillis - mLastClickTime < 1000) {
                    ...
                    ToastUtil.showtomain(AgoraMonitoring50Activity.this, getString(R.string.dont_so_fast2));
                    return;
                }
                mLastClickTime = currentTimeMillis;
                if(!isconnected) {
...
//        }
    ...
    private void playVideo() {
        ...
        if (wificheck && !checknetwork()) {
            ToastUtil.showtomain(AgoraMonitoring50Activity.this, getString(R.string.not_wifi));
            return;
        }
        if (mProgressDialog != null) {
            ...
            if (manager != null) {
                ...
                if (info != null && info.isConnected()) {
                    ...
                    if (info.getState() == NetworkInfo.State.CONNECTED
                            && !info.isAvailable()) {
                        //TODO
                        StartUtil.startintent(AgoraMonitoring50Activity.this,
