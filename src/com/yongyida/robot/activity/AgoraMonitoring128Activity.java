...
public class AgoraMonitoring128Activity extends BaseEngineEventHandlerActivity implements MeetingListener, View.OnTouchListener{
    private static final String TAG = "Agora128Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agora_monitoring_128);
        init();
    }
        ...
        mPlayBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentTimeMillis - mLastClickTime < 1000) {
                    ...
                    ToastUtil.showtomain(AgoraMonitoring128Activity.this, getString(R.string.dont_so_fast2));
                    return;
                }
                mLastClickTime = currentTimeMillis;
                if(!isconnected) {
...
//        }
    ...
    private void playVideo() {
        ...
        if (wificheck && !checknetwork()) {
            ToastUtil.showtomain(AgoraMonitoring128Activity.this, getString(R.string.not_wifi));
            return;
        }
        if (mProgressDialog != null) {
            ...
            if (manager != null) {
                ...
                if (info != null && info.isConnected()) {
                    ...
                    if (info.getState() == NetworkInfo.State.CONNECTED
                            && !info.isAvailable()) {
                        //TODO
                        StartUtil.startintent(AgoraMonitoring128Activity.this,
    ...
    private void sendcmd(String flag, final View v) {
        if (flag.equals("start")) {
            switch (v.getId()) {
                ...
                case R.id.head_up:
                    execute("head_up");
                    HandlerUtil.sendmsg(mHandler, "head_up", 0);
                    break;
                case R.id.head_left:
                    execute("head_left");
                ...
                case R.id.head_down:
                    execute("head_down");
                    HandlerUtil.sendmsg(mHandler, "head_down", 0);
                    break;
