...
public class Powerlist128Activity extends BaseActivity implements View.OnClickListener {
    private static final String TAG = "Powerlist128Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_power_list_128);
        initBase();
    ...
    private void initBase() {
        ...
        setBattery(battery);
        BroadcastReceiverRegister.reg(Powerlist128Activity.this, new String[]{Constants.BATTERY}, mBatteryBR);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.video_chat:
                ...
                StartUtil.startintent(Powerlist128Activity.this, Control128Activity.class, "no", bundle1);
                break;
            case R.id.video_monitor:
                mMode = "control";
                Bundle bundle2 = new Bundle();
                bundle2.putString("mode", mMode);
                StartUtil.startintent(Powerlist128Activity.this, Control128Activity.class, "no", bundle2);
                break;
