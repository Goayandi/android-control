 ...
 */
public class MonitoringActivity extends CallActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraHelper = new CameraHelper(callHelper, null);
        ...
        BroadcastReceiverRegister.reg(MonitoringActivity.this, new String[]{Constants.BATTERY}, mRNameBR);
    }
    ...
    private EMCallBack mCallBack = new EMCallBack() {
        ...
        public void onError(int arg0, String arg1) {
            ...
            enHandler.post(new Runnable() {
                ...
                @Override
                public void run() {
                    ToastUtil.showtomain(MonitoringActivity.this, getString(R.string.initialize_fail));
                }
            });
        }
    };
    ...
    Handler enHandler = new Handler() {
        public void dispatchMessage(android.os.Message msg) {
            if (msg.what == 0) {
                ...
                ToastUtil.showtomain(MonitoringActivity.this, getString(R.string.request_timeout));
            } else if (msg.what == 3) {
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        if (EMVideoCallHelper.getInstance().getVideoHeight() == 320
                                            ...
                                            EMChatManager.getInstance().endCall();
                                            saveCallRecord(1);
                                            ToastUtil.showtomain(MonitoringActivity.this, getString(R.string.connect_error_retry));
                                            cameraHelper.stopCapture(oppositeSurfaceHolder);
                                            toggle();
                                            play.setBackgroundResource(R.drawable.bofang);
                                        }
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (fError == CallError.REJECTED) {
                                    callingState = CallActivity.CallingState.BEREFUESD;
                                } else if (fError == CallError.ERROR_TRANSPORT) {
                                } else if (fError == CallError.ERROR_BUSY) {
                                    callingState = CallActivity.CallingState.BUSY;
                                } else if (fError == CallError.ERROR_NORESPONSE) {
                                    callingState = CallActivity.CallingState.NORESPONSE;
                                } else if (fError == CallError.ERROR_INAVAILABLE) {
                                    saveCallRecord(1);
                                    ToastUtil.showtomain(MonitoringActivity.this,
        ...
        switch (v.getId()) {
            case R.id.play:
                if (!cameraHelper.isStarted()) {
                    audioManager.setMicrophoneMute(true);
                    sendmsg("control",getSharedPreferences("Receipt", MODE_PRIVATE).getString(
                            "username", null));
                } else {
            ...
            case R.id.speak:
                ...
                if (mDialog == null) {
                    mDialog = new RecognizerDialog(MonitoringActivity.this, init);
    ...
    private void huanxinLogin() {
        EMChatManager.getInstance().login(
                ...
                new EMCallBack() {
                    ...
                    @Override
                    public void onSuccess() {
                        ToastUtil.showtomain(MonitoringActivity.this, getString(R.string.connect_error));
                        finish();
                    }
