...
public class AgoraMonitoring150Activity extends BaseEngineEventHandlerActivity implements MeetingListener, View.OnTouchListener{
    private static final String TAG = "Agora150Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agora_monitoring_150);
        init();
    }
        ...
        mPlayBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentTimeMillis - mLastClickTime < 1000) {
                    ...
                    ToastUtil.showtomain(AgoraMonitoring150Activity.this, getString(R.string.dont_so_fast2));
                    return;
                }
                mLastClickTime = currentTimeMillis;
                if(!isconnected) {
...
//        }
    ...
    private void playVideo() {
        ...
        if (wificheck && !checknetwork()) {
            ToastUtil.showtomain(AgoraMonitoring150Activity.this, getString(R.string.not_wifi));
            return;
        }
        if (mProgressDialog != null) {
            ...
            if (manager != null) {
                ...
                if (info != null && info.isConnected()) {
                    ...
                    if (info.getState() == NetworkInfo.State.CONNECTED
                            && !info.isAvailable()) {
                        //TODO
                        StartUtil.startintent(AgoraMonitoring150Activity.this,
    ...
    private void sendcmd(String flag, final View v) {
        if (flag.equals("start")) {
            switch (v.getId()) {
                ...
                case R.id.head_left:
                    execute("head_left");
                    HandlerUtil.sendmsg(mHandler, "head_left", 0);
                    break;
                case R.id.head_right:
                    execute("head_right");
                    HandlerUtil.sendmsg(mHandler, "head_right", 0);
                    break;
                case R.id.body_left:
                    execute("body_left");
                    HandlerUtil.sendmsg(mHandler, "body_left", 0);
                    break;
                case R.id.body_right:
                    execute("body_right");
                    HandlerUtil.sendmsg(mHandler, "body_right", 0);
                    break;
                default:
                    break;
            }
