...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((VoiceChatActivity) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((VoiceChatActivity) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			if (((VoiceChatActivity) activity).playMsgId != null && ((VoiceChatActivity) activity).playMsgId.equals(message.getMsgId())) {
